...
class TestCard:
    ...
    def test_save_card_to_sqlite(self, input_data, card_repository_sqlite):
        ...
        assert not deepdiff.DeepDiff(input_data.__dict__, created_card.__dict__, exclude_paths=["root['owner_id']"])
